...
export const projects = [
  {
    ...
    overview: 'A full social campaign for a premium silver jewellery house. The brief: make silver feel intimate and modern rather than loud. We built a restrained visual language \u2014 soft light, editorial typography and emotive copy \u2014 that scaled across festive and gifting moments.',
  ...
  },
  {
    ...
    type: 'video',
    cover: anfront[0],
    description: 'A multidisciplinary visual project exploring the intersection of motion, design, storytelling, and emerging AI workflows. Built from concept to final delivery, every element was crafted to create immersive visual experiences that balance aesthetic precision, emotional impact, and purposeful communication across digital platforms.',
    overview: 'Motion-led launch campaign for AN Group\u2019s \u201cOcean Blush\u201d colour story. The goal was to make an interior collection feel aspirational and calm. We designed a teaser-to-reveal sequence with fluid transitions, ambient light and gentle type animation.',
