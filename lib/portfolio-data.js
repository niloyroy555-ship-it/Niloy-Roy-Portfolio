...
export const projects = [
  ...
  },
  {
    ...
    description: 'Editorial pitch decks and brand presentations \u2014 information designed to feel effortless and premium.',
    overview: 'A collection of presentation and layout work \u2014 pitch decks, brand documents and editorial layouts. The emphasis is on hierarchy, whitespace and typography that makes dense information feel clear and confident.',
    role: 'Layout & Presentation Designer',
    software: ['InDesign', 'PowerPoint', 'Illustrator'],
    aiTools: ['ChatGPT'],
    process: [
      { t: 'Structure', d: 'Shaped the narrative and information hierarchy.' },
      { t: 'Design', d: 'Built a clean grid, type scale and visual system.' },
      { t: 'Polish', d: 'Refined spacing, charts and details throughout.' },
    ],
