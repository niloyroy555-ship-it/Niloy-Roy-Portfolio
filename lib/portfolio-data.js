...
// Each brand can carry a `logo` (transparent PNG in /public/logos). Brands
// without a logo yet just render as text in the marquee until one is added.
export const brands = [
  { name: 'Tata Trusts' },
  { name: 'Senco Gold & Diamonds' },
  { name: 'AN Group', logo: '/logos/an-group.png' },
  { name: 'Nirmala Group' },
  { name: 'Zee Bangla' },
  { name: 'ITC' },
  { name: 'Budweiser' },
  { name: 'Anaash Jewellery' },
  { name: 'Grandstreet', logo: '/logos/grandstreet.png' },
  { name: 'Aislinn' },
  { name: 'Madhogarias Silver Art', logo: '/logos/madhogarias.png' },
  { name: 'Wonderlust Ink.', logo: '/logos/wonderlust-ink.png' },
  { name: 'Premiers Tea', logo: '/logos/premiers.png' },
  { name: 'AVM Granite' },
  { name: 'Kalp Kids' },
  { name: 'Indothai' },
  { name: 'Label YM' },
  { name: 'Sresth Products Pvt. Ltd.', logo: '/logos/sresth-ora.png' },
  { name: 'Myrrah', logo: '/logos/myrrah.png' },
  { name: 'Zee Cinema' },
  { name: 'PSJ Jewellers', logo: '/logos/psj-jewellers.png' },
  { name: 'Ayushi Agarwal', logo: '/logos/ayushi-agarwal.png' },
  { name: 'Krazy Kind', logo: '/logos/krazy-kind.png' },
]
