...
export const projects = [
  ...
  },
  {
    ...
    type: 'video',
    cover: anfront[0],
    // These two projects are the ones Niloy wants playing everywhere —
    // landing-page grid card AND the modal hero preview — regardless of
    // pointer type. Every other video-type project still shows a static
    // poster on touch devices (see Media() in portfolio.js / the modal
    // hero) to keep the "no autoplaying video swarm on a phone" behavior
    // that was the whole point of the earlier tablet-perf pass.
    alwaysAutoplay: true,
  ...
  },
  {
    ...
    brand: 'Wonderlust \u00b7 Aislinn \u00b7 Anaash \u00b7 Multiple Brands',
    ...
    modalCoverPosition: 'center 8%',
    description: 'Fast, rhythmic social reels for fashion, lifestyle and retail brands, plus festive greeting films for Republic Day, Ram Navami & Maha Shivratri \u2014 built to stop the scroll.',
    overview: 'Short-form vertical edits for a range of fashion and lifestyle brands, alongside a run of festive greeting films spanning Indian festivals. The focus: punchy pacing, clean type and trend-aware transitions that still feel on-brand and premium, with each festival film balancing cultural warmth against brand restraint \u2014 kinetic typography, subtle particles and music-timed cuts.',
    ...
    process: [
      ...
      { t: 'Animate', d: 'Type, particles and light animated to a musical beat for festival films.' },
      { t: 'Publish', d: 'Optimised for Instagram & Facebook reels, vertical + square deliverables.' },
    ],
    gallery: [...reels, ...festival],
  },
  {
    id: 'frames',
